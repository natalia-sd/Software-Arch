#ifndef HTTPWALLSERVER_H
#define HTTPWALLSERVER_H
...
class HTTPWallServer : public Poco::Util::ServerApplication
{
public:
    HTTPWallServer() : _helpRequested(false)
    {
    }
