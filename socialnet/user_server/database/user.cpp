...
//             Poco::Data::Statement select(session);
//             User a;
//             select << "SELECT id, first_name, last_name, email, birthday, login, password FROM User where id=?",
//                 into(a._id),
//                 into(a._first_name),
//                 into(a._last_name),
//                 into(a._email),
...
//             User a;
//             select << "SELECT id, first_name, last_name, email, birthday, login, password FROM User",
//                 into(a._id),
//                 into(a._first_name),
//                 into(a._last_name),
//                 into(a._email),
...
//             first_name += "%";
//             last_name += "%";
//             select << "SELECT id, first_name, last_name, email, birthday, login, password FROM User where first_name LIKE ? and last_name LIKE ?",
//                 into(a._id),
//                 into(a._first_name),
//                 into(a._last_name),
//                 into(a._email),
...
//             User a;
//             login +="%";
//             select << "SELECT id, first_name, last_name, email, birthday, login, password FROM User where login LIKE ?",
//                 into(a._id),
//                 into(a._first_name),
//                 into(a._last_name),
//                 into(a._email),
...
//             insert << "INSERT INTO User (first_name, last_name, email, birthday, login, password) VALUES(?, ?, ?, ?, ?, ?)",
//                 use(_first_name),
//                 use(_last_name),
//                 use(_email),
//                 use(_birthday),
...
namespace database
{
    ...
    std::vector<User> User::read_all(long id)
    {
        try
        {
            Poco::Data::Session session = database::Database::get().create_session();
            ...
            User a;
            std::string sharding_hint = database::Database::sharding_hint(id);
            std::string select_str = "SELECT id, total_id, first_name, last_name, email, birthday, login, password FROM User ";
            select_str += sharding_hint;
            std::cout << select_str << std::endl;
